...
extension LoginViewController {
    private func setUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            emailTextField.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 15),
            ...
            iHaveNoAccount.topAnchor.constraint(equalTo: signInButton.bottomAnchor, constant: 10),
