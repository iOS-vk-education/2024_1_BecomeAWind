...
extension RegisterViewController {
    private func setUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            loginTextField.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 15),
            ...
            emailTextField.topAnchor.constraint(equalTo: loginTextField.bottomAnchor, constant: 15),
            ...
            iHaveAnAccount.topAnchor.constraint(equalTo: signUpButton.bottomAnchor, constant: 10),
